...
<div class="container-sm mt-2">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Adicionar Sala</li>
        </ol>
      </nav>
    <h1>Cadastro de nova sala</h1>
    <p>Cadastre aqui salas a serem utilizadas durante as etapas do evento.</p>
    <div class="row">
        <div class="col-md">
            <form method="POST" action="{{ route('registrarSala') }}">
                @csrf
                <div class="mb-3">
