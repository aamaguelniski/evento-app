...
<div class="container-sm mt-2">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Detalhes do espaço para café</li>
        </ol>
      </nav>
    
    <h1>{{ $cafe_info[0]->nome }}</h1>
    <div class="row">
        <div class="col-md">
            <h3>Lotação máxima: {{ $cafe_info[0]->lotacao }}</h3>
        </div>
        <div class="col-md">
            <h2>Etapa 1</h2>
            <p>Vagas disponíveis: {{ $cafe_info[0]->lotacao - count( $etapa1 ) }}</p>
        ...
        <div class="col-md">
            <h2>Etapa 2</h2>
            <p>Vagas disponíveis: {{ $cafe_info[0]->lotacao - count( $etapa2 ) }}</p>
